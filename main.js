	...
	<nav>
	    <ul class="flexbox_container"> 
		    <li class="profile_item">
		        <a class=" profile_github" :href=profile.github target="_blank" rel="noopener noreferrer" >
		   ...
		   <li class="profile_item">
		       <a class="profile_github" :href=profile.komoot target="_blank" rel="noopener noreferrer" >
		   ...
		   <li class="profile_item">
           <a class=" profile_xing" :href=profile.xing target="_blank" rel="noopener noreferrer" >
		       <svg viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg" data-xds="LogoXINGLogoDuo" height="50" width="50">
